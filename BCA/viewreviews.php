    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="" method="POST">
                ...
                <textarea name="website_experience" placeholder="Website Experience" required></textarea>
                <textarea name="website_design" placeholder="Website Design Review" required></textarea>
                <textarea name="check_in_out_process" placeholder="Check-in/Check-out Process Review" required></textarea>
